...
void	Karen::info( void ){
	std::cout << CYAN << "I cannot believe adding extra bacon costs more money. You didn’t "
	<< "put enough bacon in my burger! If you did, I wouldn’t be asking for more!" << std::endl;
}

void	Karen::warning( void ){
	std::cout << MAGENTA << "I think I deserve to have some extra bacon for free. I’ve been"
...
void	Karen::complain( std::string level )
{
    ...
    std::cout << WHITE << "[ Probably complaining about insignificant problems ]" << std::endl;
}
